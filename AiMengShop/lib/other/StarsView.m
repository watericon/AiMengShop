...
- (void)setScore:(CGFloat)score{
    ...
    for (int i = 0; i < _starViewArr.count; i ++) {
        ...
        if (i < index) {
          ...
          _percentValue=[NSString stringWithFormat:@"%f", starView.percent];
    }
...
- (void)handleTouches:(NSSet *)touches{
    ...
    StarView *starView;
     _percentValue=[NSString stringWithFormat:@"%lu",(unsigned long)_starViewArr.count];
...
//-(void)setPercentValue:(NSString *)percentValue{
//
//    percentValue=[NSString stringWithFormat:@"%lu",(unsigned long)_starViewArr.count];
//
//
//}
